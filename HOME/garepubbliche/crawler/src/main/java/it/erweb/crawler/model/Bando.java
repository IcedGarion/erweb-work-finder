...
//	{
//		return this.cdBando + ", " + this.cdEsterno + ", " + this.pubblicazione + ", " + this.cig + ", " + this.tipo
//				+ ", " + this.tiporichiedente + ", " + this.nmRichiedente + ", " + this.scadenza + ", " + this.oggetto
//				+ ", " + this.testo + ", " + this.url + ", " + this.stato;
//	}
//
//}